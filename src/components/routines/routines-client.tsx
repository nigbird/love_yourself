...
import { getRoutines, saveRoutine, deleteRoutine, markRoutineAsDone, getCompletionStatus, undoCompletion } from '../../app/routines/actions';
...
export function RoutinesClient({ initialRoutines, initialCompletionStatus }: RoutinesClientProps) {
  const [routines, setRoutines] = useState<Routine[]>(initialRoutines);
  const [editingRoutine, setEditingRoutine] = useState<Routine | null>(null);
  const [isFormOpen, setIsFormOpen] = useState(false);
  const [completionStatus, setCompletionStatus] = useState<CompletionStatus>(initialCompletionStatus);
